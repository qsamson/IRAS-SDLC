...
**Key Features:**
- 🔍 AI-based vulnerability detection using CodeBERT
- 📊 Unified risk aggregation: **R = αV + βE + γI**
- 🛡️ RMF-aligned compliance mapping
- 🔐 Zero Trust runtime adaptation
- ⚡ Early detection (negative latency)
...
```bash
# Clone repository
git clone https://github.com/qsamson/IRAS-SDLC.git
cd IRAS-SDLC
