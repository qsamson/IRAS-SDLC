"""
Quick Test Suite for IRAS-SDLC

Tests core functionality without requiring full datasets.
...
def main():
    ...
    try:
        ...
        print(f"  Input: V={V:.2f}, E={E:.2f}, I={I:.2f}")
        print(f"  Output: R={R:.3f}")
        print(f"  Classification: {level} → {action}")
        print("  ✓ PASSED")
    ...
    try:
        ...
        y_prob = np.array([0.9, 0.1, 0.85, 0.6, 0.2, 
                          0.95, 0.15, 0.55, 0.88, 0.92])
